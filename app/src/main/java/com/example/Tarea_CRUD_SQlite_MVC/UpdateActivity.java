        ...
        btnGuarda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!txtNombre.getText().toString().equals("") && !txtApellidos.getText().toString().equals("")) {
                    ...
                    if(correcto){
                        Toast.makeText(UpdateActivity.this, "Empleado modificado", Toast.LENGTH_SHORT).show();
                        verRegistro();
                    } else {
                        Toast.makeText(UpdateActivity.this, "Error al modificar empleado", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(UpdateActivity.this, "Por favor llenar todos los campos", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
